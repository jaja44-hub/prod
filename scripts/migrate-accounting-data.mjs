...
if (!OLD_DB_URL || !ACCOUNTING_DB_URL) {
  console.error('Set NEON_DATABASE_URL/NEON_ACCOUNTING_DB_URL in .env.local before running this script (no hardcoded credentials).');
  process.exit(1);
}
