...
async function seedTenantFinanceData() {
  ...
  // Tenant Billing
  const billing = [
    { tenant_id: 'tenant_default', billing_period: '2026-01', amount: 5000, status: 'paid', due_date: '2026-02-15', paid_date: '2026-02-10' },
    { tenant_id: 'tenant_default', billing_period: '2026-02', amount: 5000, status: 'paid', due_date: '2026-03-15', paid_date: '2026-03-12' },
    { tenant_id: 'tenant_default', billing_period: '2026-03', amount: 5000, status: 'pending', due_date: '2026-04-15', paid_date: null },
    { tenant_id: 'tenant_demo', billing_period: '2026-02', amount: 2500, status: 'paid', due_date: '2026-03-15', paid_date: '2026-03-14' },
    { tenant_id: 'tenant_demo', billing_period: '2026-03', amount: 2500, status: 'pending', due_date: '2026-04-15', paid_date: null }
  ];
