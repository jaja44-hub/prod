  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        ...
        className={`flex lg:!flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar ${sidebarExpanded ? 'w-64' : 'w-20'} 2xl:!w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-64"} lg:translate-x-0 ${variant === 'v2' ? 'border-r border-gray-200 dark:border-gray-700/60' : 'rounded-r-2xl shadow-sm'}`}
      >
        {/* Sidebar header */}
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className={`text-sm font-medium duration-200 ${sidebarExpanded ? 'opacity-100' : 'hidden'}`}>
                                Main
                              </span>
                            </NavLink>
                          </li>
